...
## 📄 Book Chapter ## 
1. **Du Zhen**, Liu Fan. Integrated Sensing and Communications for Emerging Applications in 6G Wireless Networks[M]. ***Fundamentals of 6G Communications and Networking***. Singapore: Springer Nature Singapore,, 2023: 377-397. (**Invited**) [\[PDF\]](https://link.springer.com/chapter/10.1007/978-3-031-37920-8_14)
2. Yuan Weijie, **Du Zhen**, Meng Xiao, et al. Integrated Sensing and Communication for Vehicular Networks[M]. ***Integrated Sensing and Communications***. Singapore: Springer Nature Singapore, 2023: 419-444. [\[PDF\]](https://link.springer.com/chapter/10.1007/978-981-99-2501-8_15)

## 📄 Journal Paper ## 
1. **Du Zhen**, Liu Fan, Li Yunxin, et al. Toward ISAC-Empowered Vehicular Networks: Framework, Advances, and Opportunities[J]. ***IEEE Wireless Communications Magazine***, 2025, 32(2): 222-229. (🔥<span style="color:red; font-weight:bold;">IEEE WCM Popular Paper</span>) [\[PDF\]](https://ieeexplore.ieee.org/abstract/document/10944644)
2. **Du Zhen**, Liu Fan, Xiong Yifeng, et al. Reshaping the ISAC Tradeoff Under OFDM Signaling: A Probabilistic Constellation Shaping Approach[J]. ***IEEE Transactions on Signal Processing***, 2024. (🔥**IEEE TSP Popular Paper**) [\[PDF\]](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10685511)
3. **Du Zhen**, Liu Fan, Yuan Weijie, et al. Integrated sensing and communications for V2I networks: Dynamic predictive beamforming for extended vehicle targets[J]. ***IEEE Transactions on Wireless Communications***, 2023, 22(6): 3612-3627. (🔥**IEEE TWC Popular Paper**) [\[PDF\]](https://ieeexplore.ieee.org/document/9947033)
4. **Du Zhen**, Zhang Fuqiang, Zhang Zenghui, et al. Radar Detector in Uncoordinated Communication Interference Plus Partially Homogeneous Clutter[J]. ***IEEE Communications Letters***, 2021, 25(6): 1999-2003. [\[PDF\]](https://ieeexplore.ieee.org/document/9353553)
5. **Du Zhen**, Zhang Zenghui, Yu Wenxian. A Multicarrier Phase-Coded Waveform Design Scheme for Joint Radar and Communication System[J]. ***Chinese Journal of Electronics***, 2021, 30(4): 769-780. [\[PDF\]](https://ietresearch.onlinelibrary.wiley.com/doi/epdf/10.1049/cje.2021.05.020)
6. **Du Zhen**, Zhang Zenghui, Yu Wenxian. Distributed target detection in communication interference and noise using OFDM radar[J]. ***IEEE Communications Letters***, 2020, 25(2): 598-602. [\[PDF\]](https://ieeexplore.ieee.org/document/9205312)
7. **Du Zhen**, Zhang Zenghui, Yu Wenxian. Information theoretic waveform design for OFDM radar‐communication coexistence in Gaussian mixture interference[J]. ***IET Radar, Sonar & Navigation***, 2019, 13(11): 2063-2070. [\[PDF\]](https://ietresearch.onlinelibrary.wiley.com/doi/epdf/10.1049/iet-rsn.2019.0276)
8. **Du Zhen**, Zhang Zenghui, Yu Wenxian. An adaptive OFDM detection strategy for range and Doppler spread targets in non-Gaussian clutter[J]. ***IEEE Access***, 2018, 6: 61223-61232. [\[PDF\]](https://ieeexplore.ieee.org/document/8492418)
9. Li Yunxin, Liu Fan, **Du Zhen**, et al. Frame Structure and Protocol Design for Sensing-Assisted NR-V2X Communications[J]. ***IEEE Transactions on Mobile Computing***, 2024. [\[PDF\]](https://ieeexplore.ieee.org/document/10502156)
10. Lu Shihang, Liu Fan, Xiong Yifeng, **Du Zhen**, et al. Sensing With Random Communication Signals[J]. ***IEEE Network***, 2025.10. [\[PDF\]](https://ieeexplore.ieee.org/document/10969844)
...
2. **Du Zhen**, Liu Fan, Zhang Zenghui. Sensing-assisted beam tracking in V2I networks: Extended target case[C]. ***IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP)***. IEEE, 2022: 8727-8731. (**Invited**) [\[PDF\]](https://ieeexplore.ieee.org/document/9747255)
